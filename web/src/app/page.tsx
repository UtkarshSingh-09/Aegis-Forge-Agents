    ...
    useEffect(() => {
        ...
        const handleData = (payload: Uint8Array, participant?: any, kind?: any, topic?: string) => {
            try {
                ...
                // [BUG FIX] Dispatch Mole popup to Mole.tsx via CustomEvent
                ...
                // Handle interview end signal
                if (data.type === "INTERVIEW_END") {
                    console.log("[INTERVIEW END RX]", data.reason);
                    setMessages(prev => [...prev, {
                        id: Date.now().toString(),
                        timestamp: getTimestamp(),
                        sender: "SYSTEM",
                        text: `Interview ended: ${data.reason || "session complete"}`
                    }]);
                }
            } catch (e) {
